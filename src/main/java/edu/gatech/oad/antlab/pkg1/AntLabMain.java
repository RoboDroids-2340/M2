 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Sahit Chintalapudi");
		  toPrint += p1.toString("schintalapudi6");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Randal Michnovicz");
		  toPrint += p2.toString("rmichnovicz3");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Joshua Jacob");
		  toPrint += p3.toString("jjacob36");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Joshua Viszlai");
                  toPrint += p4.toString("jviszlai3");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Sarah Storer");
                  toPrint += p5.toString("sstorer3");
